...
Usage:
    python agent/aw_agent.py                    # interactive REPL
    python agent/aw_agent.py "show orders at risk"  # single task, then exit
"""
...
from agent.skills_file import SkillsRegistry
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="AdventureWorks agent — streaming, adaptive thinking, progressive skills"
    )
    parser.add_argument(
        "task",
        nargs="?",
    ...
    parser.add_argument("--cwd", help="Working directory (default: Spine-Agent root)")
    parser.add_argument("--skills", help="Skills directory (default: skills/aw/)")
    parser.add_argument("--memory", help="AGENTS.md memory file (default: agent/AGENTS.md)")
    parser.add_argument("--db-host", default="localhost")
    parser.add_argument("--db-port", type=int, default=None, help="DB port (default: DB_PORT env var or 5432)")
    parser.add_argument("--db-name", default="adventureworks")
